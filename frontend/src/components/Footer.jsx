...
const Footer = () => {
    return (
        <footer class="bg-white-200 lg:grid lg:grid-cols-5 static bottom-0 left-0 right-0">
            ...
            <div class="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
                <div class="grid grid-cols-1 gap-8 sm:grid-cols-2">
                    <div>
                        ...
                        <ul class="mt-8 flex gap-6">
                            ...
                            <li>
                                <a
                                    href="https://www.instagram.com/uttej.unique/"
                                    rel="noreferrer"
                                    target="_blank"
                                    class="text-gray-700 transition hover:opacity-75"
                                >
                ...
                <div class="mt-1 border-t border-gray-100 pt-12">
                    <div class="sm:flex sm:items-center sm:justify-between">
                        ...
                        <p class="mt-8 text-xs text-gray-500 sm:mt-0">
                            &copy; 2024. Stock Market Dash. All rights reserved.
                        </p>
                    </div>
                </div>
            </div>
